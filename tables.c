...
struct mechanism_map keychain_mechmap[] = {
	{ CKM_RSA_PKCS, 1024, 8192, CKF_ENCRYPT|CKF_DECRYPT|CKF_SIGN|CKF_VERIFY,
	  &kSecKeyAlgorithmRSAEncryptionPKCS1,
	  &kSecKeyAlgorithmRSASignatureDigestPKCS1v15Raw,
	  NULL, 0	/* Special case - no digest algoritm specified */,
	  true },
	{ CKM_SHA1_RSA_PKCS, 1024, 8192, CKF_SIGN|CKF_VERIFY,
	  NULL,
	  &kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA1,
	  &kSecDigestSHA1, 0, true},
	{ CKM_SHA256_RSA_PKCS, 1024, 8192, CKF_SIGN|CKF_VERIFY,
	  NULL,
	  &kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA256,
	  &kSecDigestSHA2, 256, true },
	{ CKM_SHA384_RSA_PKCS, 1024, 8192, CKF_SIGN|CKF_VERIFY,
	  NULL,
	  &kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA384,
	  &kSecDigestSHA2, 384, true },
	{ CKM_SHA512_RSA_PKCS, 1024, 8192, CKF_SIGN|CKF_VERIFY,
	  NULL,
